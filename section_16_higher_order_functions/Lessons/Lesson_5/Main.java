...
public class Main {
    public static void main(String[] args) {
        ...
        List<String> upperUsernames = usernames.stream()
                .map(username -> username.toUpperCase()).toList();
        ...
        System.out.println("\nYou total earning are $ " + totalEarnings);
        ...
        String result = aisles.stream().filter(aisle -> aisle.equals("coffee")).findFirst().orElse(null);
