...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        AccountService checkingServices = new CheckingService(repository);

        checkingServices.desposit("1", new BigDecimal("100"));
        checkingServices.withdraw("1", new BigDecimal("50"));
