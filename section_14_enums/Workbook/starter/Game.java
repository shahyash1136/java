    ...
    public void begin(Team home, Team away) {
        ...
        System.out.println(
                "\n*****************************************************************************" +
                        ...
                        + away.getPlayer(POINT_GUARD) + "; at shooting guard, " + away.getPlayer(SHOOTING_GUARD)
                        + "; at small forward, " + away.getPlayer(SMALL_FORWARD) + "; at power forward, "
                        + away.getPlayer(POWER_FORWARD) + "; and at center, " + away.getPlayer(CENTER) + ".\n" +
